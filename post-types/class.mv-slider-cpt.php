...
if ( ! class_exists('MV_Slider_Post_Type')){
    class MV_Slider_Post_Type{
        ...
        function __construct(){
            require_once(MV_SLIDER_PATH.'util/util.php');
        ...
        public function create_post_type(){
            register_post_type(
                ...
                array(
                    ...
                    'show_ui' => true,
                    'show_in_menu' => false,
                    'menu_position' => 5, // abaixo do item de menu
        ...
        public function save_post($post_id){
            ...
            //Verifica se o wordpress esta fazendo autosave
            if( defined('DOING_AUTOSAVE') && DOING_AUTOSAVE){
                return;
            }

            //Verifica se esta na tela do CPT correto
            if(isset($_POST['post_type']) && $_POST['post_type'] === 'mv-slider'){
                
                //Verifica se o usuario logado pode editar a pagina ou o post
            ...
            if (isset( $_POST['action']) && $_POST['action'] == 'editpost'){
                ...
                $new_link_url = get_post_meta( $post_id, 'mv_slider_link_url', true );
                $new_link_url = $_POST['mv_slider_link_url'];

                //Sanitize
                $new_link_text = util::decode(sanitize_text_field($new_link_text),'Add Some Text');
                $new_link_url = util::decode(sanitize_text_field($new_link_url),'#');
        ...
        //Adiciona coluna na tabela de exibicao do CPT
